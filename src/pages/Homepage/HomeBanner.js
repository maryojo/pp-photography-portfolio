...
import BannerInfoScroll from "./BannerInfoScroll";
...
const HomeBanner = () => {
  return (
    <div className="pt-24 md:pt-16">
      <section className="flex flex-col md:flex-row justify-between gap-5 md:gap-0 md:items-center px-10">
        <div>
          <p className="text-[16px] font-[500] uppercase text-[#62646C]">
            Stunning Projects by
          </p>
          <p className="text-[3rem] md:text-[4rem] font-[600] uppercase tracking-tight">Mary</p>
        </div>
        <svg
        ...
        <div className="uppercase text-[1.5rem] md:text-[2.2rem] font-[600]">
